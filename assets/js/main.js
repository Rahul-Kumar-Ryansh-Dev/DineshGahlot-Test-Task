(function ($) {
  ...
  new simpleParallax(image, { orientation: "right", delay: 0.4 });
  $("select").niceSelect();
  ...
  $(".popup-img").magnificPopup({ type: "iframe" });
  ...
  new Swiper(".hero3-slider", {
    ...
    parallax: true,
    effect: "fade",
    pagination: { el: ".banner-paginnation", clickable: "true" },
    fadeEffect: { crossFade: true },
    autoplay: { delay: 4000 },
  });
  ...
  var swiper = new Swiper(".about-img-slider", {
    ...
    speed: 3000,
    autoplay: { delay: 1500 },
    pagination: { el: ".about-img-paginnation", clickable: "true" },
  });
  var swiper = new Swiper(".testimonial-slider", {
    ...
    speed: 3000,
    autoplay: { delay: 2000 },
    pagination: { el: ".testimonial-paginnation", clickable: "true" },
  });
  ...
  var mySwiper = new Swiper(".banner-fullscreen-slider", {
    ...
    slidesPerView: 1,
    effect: "fade",
    navigation: { nextEl: ".banner-full-prev1", prevEl: ".banner-full-next1" },
    fadeEffect: { crossFade: true },
  });
  ...
  var swiper = new Swiper(".personal-center-banner", {
    ...
    breakpoints: {
      ...
      768: { slidesPerView: 2, navigation: false },
      1200: { slidesPerView: 2, navigation: false },
      1400: { slidesPerView: 3, navigation: false },
    },
  });
  ...
  dayNight.addEventListener("click", () => {
    ...
    if (last === "dark") {
      localStorage.setItem("rahul_theme", last);
    } else {
      localStorage.setItem("rahul_theme", "");
    }
  ...
  var rahul_theme = localStorage.getItem("rahul_theme");
  if (rahul_theme === "dark") {
    $("body").addClass("dark");
  }
})(jQuery);
